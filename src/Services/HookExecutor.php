...
class HookExecutor
{
    ...
    public const HOOK_POST_EXTENSION_ON_PROJECT_INSTALL = 'postExtensionOnProjectInstall';
    ...
    public function execute(string $name): void
    {
        $steps = match ($name) {
            ...
            self::HOOK_POST_EXTENSION_ON_PROJECT_INSTALL => $this->configuration->hooks->postExtensionOnProjectInstall,
